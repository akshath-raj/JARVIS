    ...
    def __init__(self, chat_ctx: ChatContext | None = None) -> None:
        super().__init__(
            instructions=(
                ...
                "- Music or Spotify — play a song, pause/resume, skip, volume, "
                "what's playing, and anything about the user's PLAYLISTS (list "
                "them, how many songs, play a playlist, add the current song to a "
                "playlist) -> transfer_to_music.\n"
