...
_GUIDE = (
    ...
    "name. play_youtube whenever the user wants to OPEN, PLAY, WATCH, SHOW or 'pull "
    "up' ONE specific video / trailer / song / clip on YouTube ('open the new Avengers "
